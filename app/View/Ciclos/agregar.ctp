...
<?php $this->assign('title', 'Agregar Ciclo - Kappi'); ?>

<?php $this->set('titulo_vista', "Agregar Ciclo"); ?>
			...
			<div class="row">
				<div class="col s12 padding_top padding_bottom">
					...
					<div class="input-field">
						...
						<input name="data[Ciclo][nombre]" type="text" id="CicloNombre" aria-required="true" class="error" aria-invalid="true">
					</div>
...
<?php $this->Html->scriptStart(array('inline' => false)); ?>
	...
	$("#CicloFechaInicio").on("change", function(){
	    $("#CicloFechaInicio-error").css("display", "none");
	});

	$("#CicloFechaFin").on("change", function(){
	    $("#CicloFechaFin-error").css("display", "none");
	});
