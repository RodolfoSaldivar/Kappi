...
<?php $this->assign('title', 'Agregar Familias - Kappi');  ?>

<?php $this->set('titulo_vista', 'Agregar Familias'); ?>
			...
			<div class="row margin_nada">
				<div style="padding:10px 0 0 20px; font-size:20px;">
					...
					<span class="red-text">
						...
						*Tardará 5 minutos por cada 1,000 registros.<br>
					</span>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col s6 padding_top">
					<div class="input-field">
						<a href="/users/descargar_excel/plantillaFamilias" class="waves-effect waves-light btn">
