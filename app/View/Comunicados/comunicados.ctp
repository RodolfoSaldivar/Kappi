...
<?php $this->assign('title', 'Comunicados - Kappi');  ?>

<?php $this->set('titulo_vista', "Comunicados"); ?>
<?php $this->set("breadcrumbs",
	'<a class="breadcrumb">Mensajes</a>
	<a class="breadcrumb">Comunicados</a>'
) ?>
...
<?php $this->Html->scriptStart(array('inline' => false)); ?>
	...
	$(document).ready(function() {
		...
		$("#mensajes_accion_comunicados").addClass("active");
	});
